...
#
#  $ bin/test -s collective.flow -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src collective.flow.testing.FLOW_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/collective/flow/tests/robot/test_example.robot
#
