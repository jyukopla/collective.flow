...
project = os.environ.get('SPHINX_PROJECT', u'collective.flow')
copyright = os.environ.get('SPHINX_COPYRIGHT', u'Jyväskylän yliopisto')
...
latex_documents = [
    ...
    ('index', 'application.tex', u'collectiveflow',
     u'Jyväskylän yliopisto', 'manual'),
]
